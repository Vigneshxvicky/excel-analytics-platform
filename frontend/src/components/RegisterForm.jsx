...
function RegisterForm() {
  ...
  const cardClass =
    "backdrop-blur-lg p-6 sm:p-10 rounded-3xl shadow-xl w-full max-w-2xl border bg-white/70 border-white/30 transition-all duration-500 mx-4 sm:mx-0"; // Changed max-w-xl to max-w-2xl
  ...
  const inputClass =
    "mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-colors"; // Added focus background
