...
function LoginForm() {
 ...
 /* Added gradient */
          ...
          style={{
            textShadow: "1px 1px 3px rgba(0, 0, 0, 0.3)" /* Adjusted shadow */,
          }}
        >
            ...
            <div className="flex items-center my-8">
              ...
              <div
                className={`flex-grow border-t ${
                  loginType === "admin" ? "border-gray-600" : "border-gray-300"
                }`}
              ></div>{" "}
              {/* Divider color based on type */}
